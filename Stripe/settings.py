...
SECRET_KEY = 'django-insecure-036g#g41sz3jh4p3x18!mcr&*bv&4@f$_v8k^)a)%e)ysotk$4'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # <— добавляем путь к общей папке шаблонов
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
SITE_DOMAIN = os.getenv('SITE_DOMAIN', default='http://localhost:8000')
